...
import DriverImage from '../../assets/DP.webp'; // Make sure this image exists
      ...
      <Box textAlign="center" mt={4} px={{ xs: 2, sm: 4, md: 0 }}>
        <Button
          ...
          sx={{
            ...
            maxWidth: '100%',
            boxShadow: '0px 3px 12px rgba(151, 176, 103, 0.4)',
            '&:hover': {
              backgroundColor: '#2F5249',
              boxShadow: '0px 5px 15px rgba(151, 176, 103, 0.4)',
            },
          }}
